...
static void native_to_managed_trampoline_14 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, struct trampoline_struct_ffi p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [9].handle = objc_getClass ("CAPropertyAnimation");
	...
	__xamarin_class_map [18].handle = objc_getClass ("SKShapeNode");
	...
	__xamarin_class_map [47].handle = objc_getClass ("NSDecimalNumber");
	__xamarin_class_map [48].handle = objc_getClass ("UILocalNotification");
	__xamarin_class_map [49].handle = objc_getClass ("UIWindow");
	__xamarin_class_map [50].handle = objc_getClass ("GKLeaderboard");
